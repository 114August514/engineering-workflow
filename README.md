...
Claude 会在你说"帮我写个组件"、"接口怎么定"、"帮我起个新项目"、"这个 PR 我该看什么"
之类的时候自动触发。

**窄请求不走阶段机**：SKILL.md 顶部有快速路径——写前端读 `frontend.md`、
写后端读 `backend.md`、修 bug 读 `bugfix.md`，读完就干活。
只有从 0 起项目、或动了契约/权限/数据模型，才需要走完整七阶段。
